...
public class MainRunnable {
    ...
    public static void main(String[] args) {
        ...
        CajeraRunnable cajera1 = new CajeraRunnable("Cajera 1 DGB", cliente1, initialTime);
        CajeraRunnable cajera2 = new CajeraRunnable("Cajera 2 DGB", cliente2, initialTime);
