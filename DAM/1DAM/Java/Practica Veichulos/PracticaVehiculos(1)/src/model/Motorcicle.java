...
public class Motorcicle extends Vehicle {
    ...
    public Motorcicle(String brand, String plate, String model, int power, int seats, ColorEnum color, MotorEnum engine, String fabricationDate) {
